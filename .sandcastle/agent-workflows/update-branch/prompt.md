...
After resolving, run whatever checks you think are warranted — `./gradlew --no-daemon build` is the strongest repo-wide check; a narrower Gradle task is fine if the resolution is localized. If something is broken, fix what you can; if you can't, push what you have and flag it clearly in the comment.
