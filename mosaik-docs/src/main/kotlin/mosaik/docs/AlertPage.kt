...
/**
 * Alert page content block for use in both full-page and partial renders.
 */
fun FlowContent.alertPageContent() {
    h1 { +"Alert" }
    p {
 ...
 */
fun alertPage(): String = layout(ALERT) { alertPageContent() }
